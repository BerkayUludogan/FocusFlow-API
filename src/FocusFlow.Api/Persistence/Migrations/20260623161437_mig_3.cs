    ...
    public partial class mig_3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "user_email_verification_codes",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_email_verification_codes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_user_email_verification_codes_users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_email_verification_codes_UserId",
                table: "user_email_verification_codes",
                column: "UserId");
        }
